            ...
            $('#insertBtn').click(
                  ...
                  function() {
                     ...
                     if (content == "") {
                        ...
                        location.href = 'Report_insert.do?content='
                              + content + '&title=' + title
...
<body class="default">
	<div id="wrapper" class="sub">
		...
		<div class="wrap">
			...
			<h3 style="width: 1000px; float:right;">신고게시판 글쓰기</h3>
               <table style="width: 1000px; float:right; margin-bottom: 100px;" class="table table-bordered">
                  <tbody>
                        ...
                        <tr>
                           <td colspan="2">
                              <button style="float: right; type="button" onclick="location.href='Report_Main.do${rstring}'">뒤로가기 </button>

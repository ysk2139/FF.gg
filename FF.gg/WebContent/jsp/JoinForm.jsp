	          ...
	          email.val() == "" || name.val() == ""){
	            ...
	            alert("이름을 입력해주세요")
	             ...
	             id = $('#id').val();
	                ...
	                name = $('#name').val();
	            alert("회원가입이 완료되었습니다.");
	            location.href='Join.do?name='+name+'&id='+id+'&pwd='+pwd+'&pwd_check='+pwd_check+'&email='+email
					...
					<div class="col s12 z-depth-4 card-panel">
						<div class="login-form">
							...
							<div class="row margin">
								<div class="input-field col s12">
									<i class="mdi-social-person-outline prefix"></i> <i
										...
										<div id="authcheck" style="margin-left: 45px;">
										...
										<span id="emailok" style="margin-left: 45px;"></span>
									</div>
							</div>
							...
							<div class="row">
								...
								<div class="input-field col s12">
									<button type="button" class="btn waves-effect waves-light col s12" onclick="location.href='${url}'">뒤로가기</button>
								</div>
